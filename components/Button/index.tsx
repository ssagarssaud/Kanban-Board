...
// Define button variants with conditional styles
...
export interface ButtonProps
  ...
  asChild?: boolean; // Allow using a custom component instead of a button
}

// Create a reusable Button component
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    const Comp = asChild ? Slot : "button"; // Use Slot if `asChild` is true, else default to `button`
    return (
      <Comp
        // Apply conditional class names based on props
